  ...
  const CameraData = ({ src, objectDetect, dateTime }) => {
    ...
    return (
      <>
        {openCameraSettings && (
          <>
            <div className="shadow-xl absolute z-50 rounded-xl  top-[120px] left-[60%] flex gap-[6px] bg-[#FFFFFF] px-[30px] py-[12px]">
          ...
          >
            <div>
              ...
              <div className="flex flex-col">
                ...
                <CameraData
                  src={profileSquare}
                  objectDetect={"Dog Detect"}
                  dateTime={"14:32 PM 12 Jan, 2023"}
                />
                <CameraData
                  src={profileSquare}
                  objectDetect={"Person Detect"}
                  dateTime={"22:10 PM 12 Jan, 2023"}
                />
              </div>
            </div>
            <div
