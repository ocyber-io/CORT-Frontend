...
const Events = () => {
  ...
  const CustomTd = ({ icon, detection, location, time, date, rowBg }) => {
    return (
      <tr className={rowBg}>
        <td className="px-[20px] py-[7px] flex items-center text-[#3D4D53] gap-4 text-base font-medium ">
          <div className="bg-Stroke rounded-lg p-1.5">
            <img className="w-[24px] h-[24px]" src={icon} alt="" />
          </div>
          {detection}
        </td>
        <td className="px-[20px] py-[7px] text-base font-normal text-[#3D4D53]">
          {location}
        </td>
