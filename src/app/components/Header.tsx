...
const Header = () => {
  ...
  return (
    <>
      ...
      <div
        className={`w=full  flex items-center justify-between gap-5 h-fit py-2.5 px-5 rounded-10px ${
      ...
      >
        <div className="flex items-end ">
          <p className="font-poppins font-medium text-3xl not-italic leading[150%] text-Primarycolor">
            {formatTime(currentTime.hours)}:{formatTime(currentTime.minutes)}
          </p>
            ...
            <div className="flex flex-col gap-0.5">
              ...
              {adminDropdownOpen && (
                <div
                  ...
                  className="absolute top-[66px] right-[30px] mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-10"
                >
                  <div
                  ...
                  <div className="py-1">
                    ...
                    <button className="block text-[#E22828] w-full px-4 py-2 text-sm text-left  hover:bg-gray-100 focus:outline-none">
                      Logout
                    </button>
                  </div>
                </div>
