        ...
        <>
          {!editUserModal ? (
            <div className="w-full h-[100%] overflow-hidden  bg-[#3D4D53]/50 flex  justify-center items-center absolute top-0 left-0 right-0 bottom-0 z-10">
              <div className="layout-outlet h-[98%] relative  bg-white w-[570px] rounded-xl  ">
                ...
                <div className="absolute w-full h-full top-[146px] px-[32px] ">
                  <form action="" onSubmit={NewUserFormik.handleSubmit}>
                    ...
                    <button
                      type="submit"
                      className="float-right px-[26px]  py-[13px] text-white font-medium bg-[#7D3519] rounded-[10px] mt-[16px] "
                    >
                      Add New User
                    </button>
                  </form>
